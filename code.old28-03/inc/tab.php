...
}elseif(pagencours =="/Dropbox/cicat/code/evenement.php" || pagencours =="/Dropbox/cicat/code/ajout_evenement.php" || pagencours =="/Dropbox/cicat/code/modifier_evenement.php" || pagencours =="/Dropbox/cicat/code/admin_event.php"){ 
